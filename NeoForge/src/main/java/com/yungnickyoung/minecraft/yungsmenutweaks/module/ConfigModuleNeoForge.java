...
public class ConfigModuleNeoForge {
    public static void init(ModContainer container) {
        container.registerConfig(ModConfig.Type.COMMON, YMTConfigNeoForge.SPEC, "yungsmenutweaks-neoforge-26_1.toml");
    ...
    private static void bakeConfig() {
        ...
        Identifier backgroundTexture = Identifier.tryParse(YMTConfigNeoForge.backgroundTexture.get());
        if (backgroundTexture != null) {
            ...
            YungsMenuTweaksCommon.CONFIG.backgroundTexture = Identifier.withDefaultNamespace("textures/block/dirt.png");
        }
    }
}
